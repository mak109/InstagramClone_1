...
public class SharePicturesTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Here it is not required to use the getContext() as we are explicitly implementing from an interface
        imgShare.setOnClickListener(SharePicturesTab.this);
        btnShare.setOnClickListener(SharePicturesTab.this);
        ...
        switch (v.getId()){
            ...
            case R.id.btnShare:
                 ...
                 else
                 {
                     ...
                     FancyToast.makeText(getContext(),"Error: You must select a image",FancyToast.LENGTH_SHORT,FancyToast.ERROR,true).show();
                 }
...
//        FancyToast.makeText(getContext(),"Now we can access the" +
//                "images",FancyToast.LENGTH_SHORT,FancyToast.SUCCESS
//        ,true).show();
